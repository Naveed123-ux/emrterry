...
export default function MessagingModule() {
  const conversations = [
    { id: '1', participant: 'Dr. Smith', lastMessage: 'Lab results are ready', time: '2m ago', unread: true },
    { id: '2', participant: 'Sarah Johnson', lastMessage: 'Thank you for the prescription', time: '1h ago', unread: false },
    { id: '3', participant: 'Medical Staff', lastMessage: 'Appointment rescheduled', time: '3h ago', unread: false },
  ]
              ...
              <div className="space-y-4">
                <div className="flex justify-start">
                  <div className="bg-white p-3 rounded-lg shadow-sm max-w-xs">
                    <p className="text-sm">Lab results are ready for review.</p>
