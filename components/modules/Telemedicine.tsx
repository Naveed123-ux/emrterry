...
const Telemedicine: React.FC = () => {
  const sessions = [
    { id: 'TM-001', patient: 'John Smith', time: '2:00 PM', duration: '30 min', status: 'scheduled' },
    { id: 'TM-002', patient: 'Sarah Johnson', time: '2:30 PM', duration: '15 min', status: 'in-progress' },
    { id: 'TM-003', patient: 'Michael Brown', time: '3:00 PM', duration: '30 min', status: 'completed' },
  ]
